...
Этот проект состоит из двух частей: подготовка данных в базе данных (SQL) и анализ в Jupyter Notebook (Python).

### Шаг 1: Подготовка окружения

1.  **Клонируйте репозиторий** или скачайте ZIP-архив и распакуйте его.
2.  **Установите Python 3.12+** (если он еще не установлен).
3.  **Установите зависимости**, необходимые для запуска ноутбука, выполнив команду в терминале или командной строке из корня проекта:
